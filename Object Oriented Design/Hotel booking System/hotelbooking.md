...
[Reference](https://www.lintcode.com/problem/732/?utm_source=sc-libao-cyc)
...
public class Main {
    public static void main(String[] args) throws Exception{
        ...
        Hotel h2 = new Hotel(2);
        Room r11 = new Room(1, RoomType.SINGLE);       
        Room r12 =new Room(2, RoomType.SINGLE);
        Room r13 =new Room(3, RoomType.DOUBLE);
        Room r21 = new Room(1, RoomType.DOUBLE);       
        Room r22 =new Room(2, RoomType.DOUBLE);
        Room r23 =new Room(3, RoomType.SINGLE);
        ...
        Date datebegin = sdf.parse("2013-01-06");
        Date dateend = sdf.parse("2013-10-10");
        List<Hotel> l1 = bs.searchHotel(new SearchHotelRequest(datebegin, dateend, 4));
        // searchHotelRequest("2013-01-01", "2013-10-10", 5);
        
        // roomsNeeded("Single", 2);
        Map<RoomType, Integer> roomsNeeded1 = new HashMap<>();
        roomsNeeded1.put(RoomType.SINGLE, 2);
        // roomsNeeded("Single", 1, "Double", 2);
        Map<RoomType, Integer> roomsNeeded2 = new HashMap<>();
        roomsNeeded2.put(RoomType.SINGLE, 1);
        roomsNeeded2.put(RoomType.DOUBLE, 2);
        
        // roomsNeeded("Single", 1);
        Map<RoomType, Integer> roomsNeeded3 = new HashMap<>();
        roomsNeeded1.put(RoomType.SINGLE, 1);
        
        datebegin = sdf.parse("2013-01-04");
        dateend = sdf.parse("2013-01-06");
         bs.makeReservation(h1, new ReservationRequest(datebegin, dateend, roomsNeeded1));
             // ReservationRequest(Date startDate, Date endDate, Map<RoomType, Integer> roomsNeeded)
        // reservationRequest(1, "2013-01-04", "2013-01-06", 1);
...
class BookingSystem {
	...
	public List<Hotel> searchHotel(SearchHotelRequest request)
	{
		...
		for(Hotel hotel : hotels)
		{
			...
			for(Map.Entry<RoomType, List<Room>> entry : searchRes.entrySet())
			{
