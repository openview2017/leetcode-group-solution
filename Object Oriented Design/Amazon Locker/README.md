...
## Step 2. Optimization and follow-up
...
C. Assign closest locker to person given current coordinate: BFS, PriorityQueue.
D. search package: may use binary search method, check the last locker species.
...
class LockerSystem {
    ...
    // write 2 or more exceptions, don't write exception
    class NoOptimalLockerException extends Exception {
        public NoOptimalLockerException(String msg) {
            super(msg);
        }
    }
    
    class NoPackageLockerException extends Exception {
        public NoPackageLockerException(String msg) {
            super(msg);
        }
    }
}
